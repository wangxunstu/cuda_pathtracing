...
const float MaxCoordAfterRescale = 60.2f;

const Vector3Df ModelPosition = Vector3Df(20.f, 0.f, 40.f);
...
float load_object(const char *filename)
{
	...
	for (unsigned i = 0; i<g_trianglesNo; i++) {
		...
		g_triangles[i]._center += ModelPosition;
